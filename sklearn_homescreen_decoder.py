...
class ImgRecognizer3:
    ...
    def load(self):
        self._load('Training_Data/Home_Screen', 0)
        self._load('Training_Data/Not_Home_Screen', 1)
...
#driver
'''
board_box3 = (1453,959,1551,979)
home_recognizer = ImgRecognizer3()
home_recognizer.train()

while(1):
    time.sleep(.25)
    img3 = ImageGrab.grab()
    img3 = img3.crop(board_box3)
    pred3 = home_recognizer.predict(img3)
    if pred3 == 0:
        print('BATTLE OVER')
    else:
        print('.')
